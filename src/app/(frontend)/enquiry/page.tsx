...
export default function EnquiryPage() {
  ...
  const generateWhatsAppMessage = () => {
    const message = `🌴 *Ceyara Tours - Travel Enquiry* 🌴
...
Sent from Ceyara Tours Website`
  ...
  const generateEmailMessage = () => {
    ...
    parts.push('🌴 Ceyara Tours - Travel Enquiry 🌴')
    parts.push('')
    ...
    if (formData.travelers) parts.push(`👥 Number of Travelers: ${formData.travelers}`)
    if (formData.budget) parts.push(`💰 Budget Range: ${formData.budget}`)
    parts.push('')
    ...
    parts.push('---')
    parts.push('Sent from Ceyara Tours Website')
